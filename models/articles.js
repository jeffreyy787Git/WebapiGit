...
var update = function (article, id) { return __awaiter(void 0, void 0, void 0, function () {
    var keys, values, key, param, i, query, err_2;
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                keys = Object.keys(article);
                ...
                param = param.slice(0, -1);
                query = "UPDATE articles SET ".concat(key, " = ").concat(param, " WHERE id = ").concat(id);
                _a.label = 1;
            case 1:
                _a.trys.push([1, 3, , 4]);
                return [4 /*yield*/, db.run_update(query, values)];
            case 2:
                _a.sent();
                return [2 /*return*/, { status: 201 }];
            case 3:
    ...
    return __generator(this, function (_a) {
        switch (_a.label) {
            case 0:
                ...
                values = [id];
                return [4 /*yield*/, db.run_delete(query, values)];
            case 1:
                data = _a.sent();
                return [2 /*return*/, data];
        }
