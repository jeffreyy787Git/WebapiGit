...
var validateArticle = function (ctx, next) { return __awaiter(void 0, void 0, void 0, function () {
    var validationOptions, body, error_1;
    return __generator(this, function (_a) {
        switch (_a.label) {
            ...
            case 3:
                error_1 = _a.sent();
                if (error_1 instanceof jsonschema_1.ValidationError) {
                    ctx.body = error_1;
                    ctx.status = 400;
                }
                else {
